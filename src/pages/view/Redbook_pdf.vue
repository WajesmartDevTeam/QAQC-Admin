  ...
  <div class="content">
    ...
    >
      <section slot="pdf-content">
        ...
        >
          <div class="	mb-1">
            <h4 class="text-bold">Redbook Report</h4>
          </div>
        ...
        >
          ...
          <p class="subtitle">Diesel Bin Card Reading(Litrs):</p>
          <div class="row">
            <div
              class="form-group row col-sm-6"
...
export default {
  ...
  methods: {
    getForm () {
      let report = this.$store.getters.redbook
      for (let i = 0; i <= 300; i++) {
