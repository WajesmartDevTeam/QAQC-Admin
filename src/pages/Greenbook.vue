              ...
              >
                ...
                <md-table-cell md-label="Action">
                  <a
                    ...
                    v-bind:href="'greenbookview/' + item.form_id"
                  >
  ...
  methods: {
    getStats () {
      ...
      this.$socket
        ...
        .then(response => {
          if (response.type == "greenbookCompliance") {
            this.no_of_compliant = response.data.greenbook.compliant
            this.no_of_uncompliant = response.data.greenbook.non_compliant
